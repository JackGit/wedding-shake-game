...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js?sourceMap!./../node_modules/vue-loader/lib/style-rewriter.js!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./app-admin.vue", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js?sourceMap!./../node_modules/vue-loader/lib/style-rewriter.js!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./app-admin.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.fade-transition {\n    -webkit-transition: all 0.2s ease;\n    transition: all 0.2s ease;\n}\n\n.fade-enter {\n    opacity: 0;\n    /*margin-top: 5%;*/\n}\n\n.fade-leave {\n    opacity: 0;\n}\n", "", {"version":3,"sources":["/./src/app-admin.vue?f8a5e5d4"],"names":[],"mappings":";AACA;IACA,kCAAA;IAAA,0BAAA;CACA;;AAEA;IACA,WAAA;IACA,mBAAA;CACA;;AAEA;IACA,WAAA;CACA","file":"app-admin.vue","sourcesContent":["<style>\r\n    .fade-transition {\r\n        transition: all 0.2s ease;\r\n    }\r\n\r\n    .fade-enter {\r\n        opacity: 0;\r\n        /*margin-top: 5%;*/\r\n    }\r\n\r\n    .fade-leave {\r\n        opacity: 0;\r\n    }\r\n</style>\r\n\r\n<template>\r\n    <div>\r\n        <router-view transition=\"fade\" transition-mode=\"out-in\"></router-view>\r\n    </div>\r\n</template>\r\n\r\n<script>\r\n    module.exports = {};\r\n</script>"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div>\n    <div class=\"container\">\n        <div class=\"row\">\n            <div class=\"input-field col s12\">\n                <input v-el:user-name placeholder=\"user name\" id=\"loginPageUserName\" type=\"text\">\n            </div>\n            <div class=\"input-field col s12\">\n                <input v-el:password placeholder=\"password\" id=\"loginPagePassword\" type=\"password\">\n            </div>\n        </div>\n        <div class=\"row\">\n            <a class=\"col s12 waves-effect waves-light btn btn-large red white-text\" @click=\"login()\">Login</a>\n        </div>\n    </div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        checkRoomDetails: function checkRoomDetails(roomId) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    computed: {
	        ...
	        roomStatusDesc: function roomStatusDesc() {
	            var str = '';
	    ...
	    methods: {
	        allowJoin: function allowJoin() {
	            if (this.room.status === 'INIT' || this.room.status === 'END') store.actions.allowToJoinRoom(this.$route.params.roomId);else Materialize.toast('当前状态下不能“开发加入”', 1000);
	        },
	        startGame: function startGame() {
	            if (this.room.status === 'JOINING') store.actions.startRoom(this.$route.params.roomId);else Materialize.toast('当前状态下不能“开始”', 1000);
	        },
	        endGame: function endGame() {
	            if (this.room.status === 'PLAYING') store.actions.stopRoom(this.$route.params.roomId);else Materialize.toast('当前状态下不能“结束游戏”', 1000);
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./room-edit-page.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./room-edit-page.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n", "", {"version":3,"sources":[],"names":[],"mappings":"","file":"room-edit-page.vue","sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./room-create-page.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./room-create-page.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n", "", {"version":3,"sources":[],"names":[],"mappings":"","file":"room-create-page.vue","sourceRoot":"webpack://"}]);
